...
export const hungary: TeamFromWiki = {
  ...
  players: [
    ...
    { name: "Attila Szalai", squadNumber: 4, positions: [Positions.DF] },
    ...
    { name: "Filip Holender", squadNumber: 11, positions: [Positions.FW] },
    { name: "Roland Varga", squadNumber: 17, positions: [Positions.FW] },
    { name: "Kevin Varga", squadNumber: 19, positions: [Positions.FW] },
    { name: "Roland Sallai", squadNumber: 20, positions: [Positions.FW] },
